    ...
    return (
       <div>
          <Modal title="导入"
              ...
              onOk={this.handleOk}
              width={600} wrapClassName="import-popup-modal"
            >
            <div className="import-conten">
              <p> <i className={this.state.ischeck}  onClick={this.oncheckedqb}></i> <span>全部导入</span> <em>会替换今天已有的沽清设置</em></p>
              <p> <i className={this.state.nocheck}  onClick={this.oncheckedzj}></i> <span>追加导入</span> <em>只导入今天没有设置的商品</em></p> 
            </div>
          </Modal>
