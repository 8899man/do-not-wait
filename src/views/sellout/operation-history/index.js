...
function Historylist({selloutStore, history}) { 
	 return  <li className="each-history">
                <div>
                    <p>{history.productName}</p> 
                </div>
                <div>
                    <p>操作类型：<span>{history.changeTypeName}</span></p> 
                     <p>数量：<span>{history.changeFloatQuantity}</span></p>
                </div>
                <div>
                    <p>操作原因：<span>{history.changeReason}</span></p> 
                </div>
                <div>
                   {history.authorizer && <p>授权人：<span>{history.authorizer}</span></p>} 
                   {history.creator && <p>操作人：<span>{history.creator}</span></p>} 
                </div>
                <div>
                    <p>操作时间：<span>{history.createTime}</span></p> 
                </div>
            </li> 
        ...
        <div className="operation-history">
                ...
                <div className="operation-history-top">
                    ...
                    <div className="div-czlx" 
                        ...
                        {selloutStore.operatetype.typeName? selloutStore.operatetype.typeName:'全部'} 
                    ...
                    <input type="text" className="search-input" placeholder="请输入商品/拼音码/原因进行查询" onKeyUp={this.reachValue}/>
                    <button className="search-button" 
                        ...
                        <i className="iconfont icon-home_icon_searchx"></i> 查询
                    </button>
                </div> 
                <div className="operation-history-main"> 
                    <MyScroll>  
                        {selloutStore.Operationhistorylist.length ? selloutStore.Operationhistorylist.map((history,index) => { 
                            return <Historylist key={index} selloutStore={selloutStore} history={history} />
