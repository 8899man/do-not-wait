...
@inject('cashierStore','dishesStore') @observer
			 ...
			 <div id="double-screen">
				<div className="account-header">
					<div className="header-left">
						<div className="merchant-img"></div>
				...
				<div id="account_container">
					<div id="account_con_left">
						...
						dishesStore.shoppingCart.length ? <WillOrderList /> :<div className="welcome-log">
                            ...
                            <div className={classnames({
                                ...
                                <div className="dishes-demo-cont">这里是备注这里是备注这里是备注这里是备注这里是备注</div>
                            </div>
                        </div>
                        <div className="left-account">
                            <div className="amount">
                                <p>96.00<span>消费金额</span></p>
                                <p>12.00<span>优惠金额</span></p>
                                <p className="receivable">84.00<span>应收金额</span></p>
                                <p>50.00<span>已收金额</span></p>
                                <p className="dine-card">餐牌号<span>3</span></p>
                            </div>
